...
**1.** Let \(a\) be a point of the open unit disc \(\mathbb D\); for \(z\in\mathbb C\) not equal to \(1/\overline a\) define
\[
...
**9.** Defining \(J_n(z)\) to be the coefficient of \(\zeta^n\) in the Laurent expansion of the function \(\exp\{\tfrac12 z(\zeta-\zeta^{-1})\}\) of \(\zeta\) about zero, show that
\[
