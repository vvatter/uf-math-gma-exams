...
*Please write up solutions to the eight problems 1–8 below. Please write LARGE, as the grader’s eyes are older and weaker than your eyes. A square \(S\subset\mathbb C\) is a set of the form \([a,a+L]\times[b,b+L]\), where \(L\) is positive. Use “\(s:=\mathrm{Foo}\)” to mean that Foo is the definition of the new symbol \(s\).*
