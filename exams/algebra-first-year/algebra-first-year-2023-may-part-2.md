# Algebra, first year exam, May 2023, Part 2
...
* (i) List all irreducible polynomials in \(\mathbb{F}_2[X]\) of degree at most three.
* (ii) List representatives for each conjugacy class of the group \(GL_3(\mathbb{F}_2)\).
