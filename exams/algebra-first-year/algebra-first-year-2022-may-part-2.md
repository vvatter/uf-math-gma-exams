...
**5.** Determine the conjugacy classes of elements of order 8 in \(\mathrm{GL}(4,\mathbb{Q}(\sqrt{2}))\). (Hint: Factorize \(x^4+1\) in \(\mathbb{Q}(\sqrt{2})[x]\).)

**6.** Let \(E\) be an extension field of the field \(F\).
* (a) What does it mean for \(E\) to be an algebraic extension of \(F\)?
* (b) Show that if \(\alpha\) and \(\beta\) are elements of \(E\) that are both roots of the same irreducible polynomial in \(F[x]\), then the subfields \(F(\alpha)\) and \(F(\beta)\) of \(E\) are isomorphic.
