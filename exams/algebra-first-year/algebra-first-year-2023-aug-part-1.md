...
* (i) Show that there is an injective homomorphism \(G \to G/H \times G/K\).
* (ii) Show that if \(G = HK\) then \(G\) is isomorphic to \(G/H \times G/K\).

**2.** Suppose \(G\) is a finite group, \(p\) is a prime, \(|G|\) is a power of \(p\) and \(G \times S \to S\) is an action of \(G\) on \(S\). Show that if \(p\) does not divide \(|S|\) then \(S\) has an element fixed by every element of \(G\).
