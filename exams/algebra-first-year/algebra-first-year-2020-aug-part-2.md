...
**1.** Suppose \(R\) is a commutative ring with identity and \(F\) is a free \(R\)-module of rank \(n\). Show that for any \(R\)-module \(M\) the \(R\)-module \(\operatorname{Hom}_R(F,M)\) is isomorphic to the direct sum of \(n\) copies of \(M\).
...
**4.** Suppose \(F\) is a field, \(V\) is an \(F\)-vector space and \(f:V\to V\) is a linear map.
