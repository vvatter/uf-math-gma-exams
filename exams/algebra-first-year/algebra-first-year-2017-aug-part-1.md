...
**5.** Let \(G\) be a group that is the internal direct product of two characteristic subgroups \(H\) and \(K\). Show that \(\operatorname{Aut}(G) \simeq \operatorname{Aut}(H) \times \operatorname{Aut}(K)\). Can the hypothesis that \(H\) and \(K\) are characteristic be omitted?
