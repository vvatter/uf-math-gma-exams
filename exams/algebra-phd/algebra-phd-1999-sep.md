...
**4.** Let \(R\) and \(S\) be rings and \(A_R, {}_R B_S, C_S\) (bi)-modules. Demonstrate an isomorphism of abelian groups between \(\operatorname{Hom}_S(A\otimes_R B,C)\) and \(\operatorname{Hom}_R(A,\operatorname{Hom}_S(B,C))\). (You should state very clearly what must be checked.)
