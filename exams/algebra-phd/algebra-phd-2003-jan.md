...
**4.** Let \(\zeta\) be a primitive 2003-rd root of unity. Prove that \(\mathbb Q(\zeta)\) is a Galois extension of \(\mathbb Q\). Calculate the Galois group of \(\mathbb Q(\zeta)/\mathbb Q\) and the degree \([\mathbb Q(\zeta):\mathbb Q]\) of the extension. Furthermore, calculate the degree \([\mathbb Q(\zeta)\cap\mathbb R:\mathbb Q]\). (Hint: 2003 is a prime).
