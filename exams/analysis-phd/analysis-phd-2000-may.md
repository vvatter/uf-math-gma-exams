...
**1.** State and prove the Vitali Convergence Theorem for integrals.

**2.** State and prove the Martingale Convergence Theorem.

**3.** Let \((X,\mathcal B,\mu)\) and \((Y,\mathcal J,\nu)\) be finite measure spaces. Construct \(\mu\otimes\nu\) on \(\mathcal B\otimes\mathcal J\). Give details.

**4.** Let \(\{\mu_m\}\) be a sequence of real valued signed measures on \((S,\Sigma)\). Define
\[
...
**5.** Let \(f:[0,b]\to\mathbb R\) be Lebesgue integrable. Suppose \(\int_{[0,c]}f\,dm=0\) for each \(c\in[0,b]\). Show \(f=0\) a.e. \(m\).

**6.** Let \((\Omega,\mathcal F,P)\) be a pr. space, \(Y\) an integrable r.v. and \(\mathcal E\) a sub σ-field of \(\mathcal F\). Suppose \(\mathcal E\) and \(\mathcal F(Y)\) are independent. What is \(E(Y\mid\mathcal E)\)? Prove.
