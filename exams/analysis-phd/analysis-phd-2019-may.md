...
**1.** Let \(X,Y\) be topological spaces. Prove that if \(f:X\to Y\) is continuous, then \(f\) is Borel measurable.

**2.** Rigorously determine the following expressions:
* (a) \[\lim_{n\to\infty}\int_0^\infty \frac{\sin(x/n)}{(1+x/n)^n}\,dx\]
* (b) \[\lim_{n\to\infty}\int_0^\infty \frac{n\sin(x/n)}{x(1+x^2)}\,dx\]
* (c) \[\lim_{n\to\infty}\int_0^\infty \frac{n}{n^2+x^2}\,dx\]
...
**4.** State and prove the Hahn decomposition theorem. For the proof, you may want to consider a sequence of sets such that \(\mu(E_n)\to\sup_E\mu(E)\) rapidly, under the assumption that such a supremum is bounded.
