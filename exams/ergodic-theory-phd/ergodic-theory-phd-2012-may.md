...
* (b) Show that \((\Sigma_2,\mathcal B,\mu_p,\sigma)\) is strong mixing (you don’t have to prove it is a \(mpt\), you may assume that is true).
* (c) Define \(\alpha:\Sigma_2\to\mathbb R\) by
  ...
  \[
  \lim_{N\to\infty}\frac{1}{N}\sum_{i=0}^{N-1}\alpha\bigl(\sigma^i(\underline{s})\bigr).
  \]
  and justify your answer completely.
