...
**1.** Equip the circle \(\mathbb{R}/\mathbb{Z}\) with the usual Lebesgue measure. Let \(\alpha\in\mathbb{R}\) be irrational and let \(T:\mathbb{R}/\mathbb{Z}\to\mathbb{R}/\mathbb{Z}\) be rotation by \(\alpha\), i.e., \(T(x)=x+\alpha\pmod{\mathbb{Z}}\). Prove that \(T\) is ergodic.
