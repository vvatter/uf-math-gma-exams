...
\hypersetup{
  pdftitle={Numerical Analysis PhD Exam, May 2018, Part 2},
...
\renewcommand{\@maketitle}{%
  ...
  \vskip -0.5em%
  \tagstructbegin{tag=H1,title={Numerical Analysis PhD Exam, May 2018, Part 2}}%
  \tagpdfparaOff%
  \tagmcbegin{tag=H1}%
    {\LARGE\bfseries\href{https://gma.math.ufl.edu/exams/numerical-analysis-phd/}{Numerical Analysis PhD Exam}, May 2018, Part 2\par}%
  \tagmcend%
  \tagpdfparaOn%
  \tagstructend%
  \vskip 0.25em%
...
\makeatother
\title{Numerical Analysis PhD Exam, May 2018, Part 2}
\author{}
\date{}
\begin{document}
\maketitle
