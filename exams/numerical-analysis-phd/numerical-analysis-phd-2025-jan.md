...
**7.** Let \(f\in C[0,1]\) and let \(\sum_{i=1}^n w_i f(x_i)\) (\(n\geq 1\)) be an approximation to \(\int_0^1 f(x)\,dx\). Assume that \(0\leq w_i\leq 1\), \(0\leq x_i\leq 1\) (\(i=1,2,\ldots,n\)). Let
