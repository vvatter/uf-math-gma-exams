...
**2.** Let \((X,d)\) be a metric space and \(E\subseteq X\) a nonempty subset. Consider the function \(d_E:X\to[0,+\infty)\) defined by
\[
...
**5.** Let \(f:\mathbb{R}\to\mathbb{R}\) be a differentiable function, and suppose that \(f'\) is monotone. Must \(f'\) be continuous? Prove, or give a counterexample.
