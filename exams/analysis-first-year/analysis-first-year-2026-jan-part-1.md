...
**4.** Let \(f : \mathbb{R} \to \mathbb{R}\) be uniformly continuous and let \(B \subseteq \mathbb{R}\) be bounded. Must \(f(B)\) be bounded? Proof or counterexample.

**5.** The continuous function \(f : \mathbb{R} \to \mathbb{R}\) is differentiable except perhaps at the point \(a\). Decide whether \(f\) is necessarily differentiable at \(a\) if it is further assumed that \(f'(t) \to 0\) as \(t \to a\).
