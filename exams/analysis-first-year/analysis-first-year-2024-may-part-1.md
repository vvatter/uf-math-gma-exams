...
**5.** Let \(f:(0,\infty)\to\mathbb{R}\) be differentiable and let \(b\in\mathbb{R}\). Prove that if \(f'(t)\to b\) as \(t\to\infty\) then \(f(t)/t\to b\) as \(t\to\infty\). [It might help to choose and fix \(a>0\).]
