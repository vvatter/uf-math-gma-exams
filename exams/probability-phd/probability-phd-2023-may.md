...
* 2. Prove the strong law of large numbers under the additional assumption of finite fourth moment \(\bigl(\mathbb{E}[X_1^4]<+\infty\bigr)\).
...
**5.** Let \(\{a_n\}_{n\ge1}\) be a sequence of real numbers such that \(0<\sum_{k=1}^{+\infty}|a_k|^2<+\infty\). Denote
\[
...
* 1. Prove that \(\{S_n\}\) is an \(\{\mathcal{F}_n\}\)-martingale.
