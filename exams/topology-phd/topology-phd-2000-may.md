...
**4.** Suppose that \(f,g:X\to S^n\) are two maps such that \(f(x)\) and \(g(x)\) are not antipodal for all \(x\in X\). Show that \(f\) and \(g\) are homotopic.
...
**9.** Define the mapping cylinder of \(f:X\to Y\). Define the mapping torus of \(f:X\to X\).
