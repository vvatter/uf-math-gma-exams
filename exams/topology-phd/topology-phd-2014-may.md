...
*For Problems 1–5: Work the following problems and show all work. Support all statements to the best of your ability. For Problems 6–15: Answer the following with complete definitions or statements or short proofs.*
...
**10.** Compute the Euler characteristic \(\chi(\mathbb{RP}^2\times S^1\times S^2\times S^3)\).
