...
**5.** Let \(GL(n)\) be the space of all invertible real \(n \times n\)-matrices. IS \(GL_n\) is compact? connected?

*Answer the following with complete definitions or statements or short proofs.*

**6.** Explain why every map \(S^n \to S^1\), \(n>1\) is null-homotopic.

**7.** State the Lefschetz Fixed Point Theorem. Explain that every continuous map \(D^n \to D^n\) has a fixed point.
...
**10.** Does every function \(f:\mathbb{N}\to\mathbb{R}\) admits a continuous extension \(\bar f:\beta\mathbb{N}\to\mathbb{R}\) of the Stone–Čech compactification?
...
**14.** Let \(X\) be a compact Hausdorff topological space. Describe all compact subsets of the space \(C(X,\mathbb{R})\) of continuous functions \(X\to\mathbb{R}\) in uniform topology.
