...
**3.** Does there exists a covering space of the figure eight with nontrivial abelian fundamental group?
...
**11.** Let \(S_r(x,y)\) denote a circle of radius \(r\) centered at \((x,y)\in\mathbb{R}^2\). Let \(\Sigma R\) be the suspension over Hawaiian ring \(R=\bigcup_{n=1}^{\infty}S_{1/n}(1/n,0)\). Is \(\Sigma R\)
