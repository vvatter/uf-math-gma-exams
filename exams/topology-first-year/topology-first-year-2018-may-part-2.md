...
**2.** Suppose that the continuous maps \(f,g:X\to Y\) are homotopic and that the continuous maps \(h,k:Y\to Z\) are homotopic. Show that \(h\circ f\) is homotopic to \(k\circ g\).
...
**8.** Suppose that \(f,g:X\to\mathbb{R}^n\) are continuous functions. Show that \(f\) and \(g\) are homotopic.
...
**12.** Is the squaring map \(s:S^1\to S^1\), \(s(z)=z^2\), nullhomotopic?
