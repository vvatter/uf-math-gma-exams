...
**2.** Let \(X\) be a connected normal topological space having more than one point. Can \(X\) be countable?

**3.** Prove that homotopy equivalent path connected spaces have isomorphic fundamental groups.
...
**7.** Define the Stone–Čech compactification and state its characterizing property.

**8.** Give an example of a connected space \(X\) with two points \(x_0\) and \(x_1\) such that \(\pi_1(X,x_0)\) is not isomorphic to \(\pi_1(X,x_1)\).

**9.** Compute the fundamental groups \(\pi_1(\mathbb{R}^n \setminus 0)\) for all \(n>1\).

**10.** Is the square map \(s:S^1\to S^1\), \(s(z)=z^2\), nullhomotopic?
