...
\renewcommand{\@maketitle}{%
  ...
  \vskip -0.5em%
  \tagstructbegin{tag=H1,title={Topology First-Year Exam, May 2020, Part 2}}%
  \tagpdfparaOff%
  \tagmcbegin{tag=H1}%
...
\textbf{Warning: Suspected error.} The displayed definition is mathematically inconsistent over the stated real domain: \(\sqrt{x}\) is not real-valued for negative~\(x\). The intended correction to the domain or formula is not uniquely determined, so the source reading has been retained.
\end{problemconcern}
