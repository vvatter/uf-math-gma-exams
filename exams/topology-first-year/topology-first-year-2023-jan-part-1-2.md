...
**4.** Let \(X=[-1,1]\times\{0\}\cup\{0\}\times[-1,1]\subset\mathbb{R}\times\mathbb{R}\). Show that every continuous map \(f:X\to X\) has a fixed point.
...
* (b) Define the Stone–Čech compactification \(\beta X\) of \(X\).
