...
**7.** Let \(E\) and \(B\) be topological spaces. Define what it means for a function \(p:E\to B\) to be a covering map.
...
**9.** Let \(\alpha\) be a path in \(X\) from \(x_0\) to \(x_1\). Define the map \(\hat{\alpha}:\pi_1(X,x_0)\to\pi_1(X,x_1)\) and show that \(\hat{\alpha}\) is a group isomorphism.

**10.** State the Seifert–van Kampen Theorem.

**11.** Let \(S^n\) be the \(n\)-sphere. Prove that \(\pi_1(S^n)\) is trivial for \(n\ge 2\).
