...
* (a) Show that every continuous map \(f:[0,1]\to[0,1]\) has a fixed point. Is this true for continuous maps
* (b) \(f:(0,1)\to(0,1)\)?
* (c) \(f:[0,1]\to[0,1)\)?
...
**7.** State the Cantor–Schröder–Bernstein Theorem.

**8.** Is every connected space path connected?

**9.** What is a basis of a topology? Does the set of all half-open intervals \(\{(a,b],[c,d)\mid a<b,\ c<d\}\) form a basis of a topology on \(\mathbb{R}\)?

**10.** Is \(\mathbb{R}^{\omega}\) connected in the uniform topology?
