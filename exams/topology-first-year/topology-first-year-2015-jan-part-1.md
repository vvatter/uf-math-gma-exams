...
**2.** Show that there is no continuous function \(f:\mathbb{R}\to\{0,1\}\) which is onto.

**3.** Let \(X\) be a metric space and let \(f:X\to X\) be a continuous function. Suppose that there is a point \(x_0\in X\) such that \(f^n(x_0)\to z\) as \(n\to\infty\). Show that \(f(z)=z\).
...
**13.** Let \(n\ge 2\). Suppose that \(A\) is a countable subset of \(\mathbb{R}^n\). Let \(X=\mathbb{R}^n\setminus A\). Is \(X\) arcwise connected?
