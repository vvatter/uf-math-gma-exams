...
**2.** Let \(X\) be a connected metric space having more than one point. Can \(X\) be countable?
...
**14.** Is the subspace \(X=\{(x,y)\in\mathbb{R}^2\mid y=\frac{1}{x}\}\) compact? locally compact?
